// Dan  3/24/2003  \DanLP105\Plugin\Textures\Eyeball\TexApp.cpp
//
...
BOOL CTextureApp::InitInstance() {
    ...
    m_sizeinfo = HFloatPropertyInfo::New(string, "Pupil Size");
    m_sizeinfo->SetDefaultValue(3.0F);
    ...
    m_sfreqinfo = HFloatPropertyInfo::New(string, "Iris Size");
    m_sfreqinfo->SetDefaultValue(8.0F);
