// Dan  3/24/2003  \DanLP105\Plugin\Textures\Dented\TexApp.cpp
//
...
BOOL CTextureApp::InitInstance() {
    ...
    m_sizeinfo->GetX()->SetMatchName("X-Size");
    m_sizeinfo->GetX()->SetFactorValue(1.F);
    m_sizeinfo->GetX()->SetDefaultValue(10.F);
    m_sizeinfo->GetX()->SetMinValue(0.F);
    m_sizeinfo->GetX()->SetMaxValue(10000.0F);
    m_sizeinfo->GetY()->SetMatchName("Y-Size");
    m_sizeinfo->GetY()->SetFactorValue(1.F);
    m_sizeinfo->GetY()->SetDefaultValue(10.F);
    m_sizeinfo->GetY()->SetMinValue(0.F);
    m_sizeinfo->GetY()->SetMaxValue(10000.0F);
    m_sizeinfo->GetZ()->SetMatchName("Z-Size");
    m_sizeinfo->GetZ()->SetFactorValue(1.F);
    ...
    m_bumpinfo->SetFactorValue(10.F);
    m_bumpinfo->SetDefaultValue(6.0F);
    m_bumpinfo->SetMinValue(0.F);
    m_bumpinfo->SetMaxValue(10.F);
    ...
    m_freqinfo->SetFactorValue(100.F);
    m_freqinfo->SetDefaultValue(2.2F);
    m_freqinfo->SetMinValue(0.F);
    m_freqinfo->SetMaxValue(10.F);
    ...
    m_amplinfo->SetFactorValue(100.F);
    m_amplinfo->SetDefaultValue(.5F);
    m_amplinfo->SetMinValue(0.F);
    m_amplinfo->SetMaxValue(1.F);
    ...
    m_weightinfo->SetFactorValue(10.F);
    m_weightinfo->SetDefaultValue(4.0F);
    m_weightinfo->SetMinValue(0.F);
    m_weightinfo->SetMaxValue(10.F);
