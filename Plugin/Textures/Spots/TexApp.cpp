// Dan  3/24/2003  \DanLP105\Plugin\Textures\Spots\TexApp.cpp
//
...
BOOL CTextureApp::InitInstance() {
    ...
    m_freqinfo->SetDefaultValue(2.F);
    ...
    m_sizeinfo = HFloatPropertyInfo::New(string, "Size");
    m_sizeinfo->SetDefaultValue(50.0F);
    m_sizeinfo->SetMinValue(0.F);
    m_sizeinfo->SetMaxValue(100.F);
    m_sizeinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);

    string.LoadString(IDS_SFREQ);
    m_sfreqinfo = HFloatPropertyInfo::New(string, "SFreq");
    m_sfreqinfo->SetDefaultValue(10.F);
    m_sfreqinfo->SetMinValue(0.F);
    m_sfreqinfo->SetMaxValue(100.F);
    m_sfreqinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);

    string.LoadString(IDS_SOFT);
    m_softinfo = HFloatPropertyInfo::New(string, "Softness");
    m_softinfo->SetDefaultValue(20.0F);
    m_softinfo->SetMinValue(0.F);
    m_softinfo->SetMaxValue(100.F);
    m_softinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);
