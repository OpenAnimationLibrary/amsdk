// Dan  3/24/2003  \DanLP105\Plugin\Textures\RimLit\TexApp.cpp
//
...
BOOL CTextureApp::InitInstance() {
    ...
    m_lightinfo->GetX()->SetDefaultValue(1.F);
    m_lightinfo->GetX()->SetMinValue(-100.F);
    m_lightinfo->GetX()->SetMaxValue(100.F);
    m_lightinfo->GetY()->SetDefaultValue(5.0F);
    ...
    m_foinfo->SetDefaultValue(5.0F);
    m_foinfo->SetMinValue(-100.F);
    ...
    m_mixinfo->SetDefaultValue(10075.0F);
