// Dan  3/24/2003  \DanLP105\Plugin\Textures\WaterColour\TexApp.cpp
//
...
BOOL CTextureApp::InitInstance() {
    ...
    m_bcolorinfo->GetGreen()->SetDefaultValue(0.31F);
    m_bcolorinfo->GetBlue()->SetDefaultValue(0.47F);

    string.LoadString(IDS_FCOLOR);
    m_fcolorinfo = HColorPropertyInfo::New(string, "FColor");
    m_fcolorinfo->GetRed()->SetDefaultValue(0.78F);
    m_fcolorinfo->GetGreen()->SetDefaultValue(0.59F);
    ...
    m_fuzzinfo->SetDefaultValue(20.0F);
    ...
    string.LoadString(IDS_VAR);
    m_varinfo = HFloatPropertyInfo::New(string, "Variation");
    m_varinfo->SetDefaultValue(0.F);
    m_varinfo->SetMinValue(0.F);
    m_varinfo->SetMaxValue(100.F);
    m_varinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);

    string.LoadString(IDS_VSCALE);
    m_vscaleinfo = HFloatPropertyInfo::New(string, "VScale");
    m_vscaleinfo->SetDefaultValue(0.F);
    m_vscaleinfo->SetMinValue(0.F);
    m_vscaleinfo->SetMaxValue(100.F);
    m_vscaleinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);
