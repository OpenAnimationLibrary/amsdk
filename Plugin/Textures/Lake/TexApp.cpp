// Dan  3/24/2003  \DanLP105\Plugin\Textures\Lake\TexApp.cpp
//
...
BOOL CTextureApp::InitInstance() {
    ...
    m_bumpinfo->SetDefaultValue(10.F);
    ...
    string.LoadString(IDS_WO);
    m_woinfo = HFloatPropertyInfo::New(string, "Windoctaves");
    m_woinfo->SetDefaultValue(4.0F);
    m_woinfo->SetMinValue(0.F);
    m_woinfo->SetMaxValue(100.F);
    m_woinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);

    string.LoadString(IDS_WAMP);
    m_wampinfo = HFloatPropertyInfo::New(string, "windfreq");
    m_wampinfo->SetDefaultValue(50.0F);
    m_wampinfo->SetMinValue(0.F);
    m_wampinfo->SetMaxValue(100.F);
    m_wampinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);

    string.LoadString(IDS_WLAC);
    m_wlacinfo = HFloatPropertyInfo::New(string, "windamp");
    m_wlacinfo->SetDefaultValue(100.F);
    m_wlacinfo->SetMinValue(0.F);
    m_wlacinfo->SetMaxValue(100.F);
    m_wlacinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);

    string.LoadString(IDS_WGAIN);
    m_wgaininfo = HFloatPropertyInfo::New(string, "Windoctaves");
    m_wgaininfo->SetDefaultValue(30.0F);
    m_wgaininfo->SetMinValue(0.F);
    m_wgaininfo->SetMaxValue(100.F);
    m_wgaininfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);
