// Dan  3/24/2003  \DanLP105\Plugin\Textures\Metallic\TexApp.cpp
//
...
BOOL CTextureApp::InitInstance() {
    ...
    m_bcolorinfo->GetRed()->SetDefaultValue(0.47F);
    ...
    m_fcolorinfo->GetRed()->SetDefaultValue(0.98F);
    m_fcolorinfo->GetGreen()->SetDefaultValue(0.47F);
    m_fcolorinfo->GetBlue()->SetDefaultValue(0.47F);

    string.LoadString(IDS_FREFLECT);
    m_frefinfo = HFloatPropertyInfo::New(string, "Specular");
    ...
    m_boinfo->SetDefaultValue(100.F);
    ...
    m_fuzzinfo = HFloatPropertyInfo::New(string, "Environment");
    ...
    m_ysinfo->SetDefaultValue(50.0F);
    ...
    m_pencilinfo = HFloatPropertyInfo::New(string, "Bump");
    m_pencilinfo->SetDefaultValue(10.F);
    ...
    m_roughinfo = HFloatPropertyInfo::New(string, "Reflect");
    ...
    string.LoadString(IDS_TX);
    m_txinfo = HFloatPropertyInfo::New(string, "txrepeat");
    m_txinfo->SetDefaultValue(1.F);
    m_txinfo->SetMinValue(1.F);
    m_txinfo->SetMaxValue(100.F);
    m_txinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);

    string.LoadString(IDS_TY);
    m_tyinfo = HFloatPropertyInfo::New(string, "tyrepeat");
    m_tyinfo->SetDefaultValue(1.F);
    m_tyinfo->SetMinValue(1.F);
    m_tyinfo->SetMaxValue(100.F);
    m_tyinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);

    string.LoadString(IDS_DA);
    m_dainfo = HFloatPropertyInfo::New(string, "Dinkamt");
    m_dainfo->SetDefaultValue(-10.F);
    m_dainfo->SetMinValue(1.F);
    m_dainfo->SetMaxValue(100.F);
    m_dainfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);

    string.LoadString(IDS_DF);
    m_dfinfo = HFloatPropertyInfo::New(string, "Dinkfrom");
    m_dfinfo->SetDefaultValue(20.0F);
    m_dfinfo->SetMinValue(1.F);
    m_dfinfo->SetMaxValue(100.F);
    m_dfinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);

    string.LoadString(IDS_DT);
    m_dtinfo = HFloatPropertyInfo::New(string, "Dinkto");
    m_dtinfo->SetDefaultValue(40.0F);
    m_dtinfo->SetMinValue(1.F);
    m_dtinfo->SetMaxValue(100.F);
    m_dtinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);
