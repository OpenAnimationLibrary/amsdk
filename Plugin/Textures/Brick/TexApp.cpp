// Dan  3/24/2003  \DanLP105\Plugin\Textures\Brick\TexApp.cpp
//
...
BOOL CTextureApp::InitInstance() {
    ...
    CString string;
    // New Infos here
    string.LoadString(IDS_BRICKWIDTH);
    m_bwidthinfo = HFloatPropertyInfo::New(string, "BrickWidth");
    m_bwidthinfo->SetDefaultValue(25.0F);
    m_bwidthinfo->SetMinValue(0.F);
    m_bwidthinfo->SetMaxValue(10000.0F);
    m_bwidthinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);

    string.LoadString(IDS_BRICKHEIGHT);
    m_bheightinfo = HFloatPropertyInfo::New(string, "Brick Height");
    m_bheightinfo->SetDefaultValue(8.0F);
    m_bheightinfo->SetMinValue(0.F);
    m_bheightinfo->SetMaxValue(10000.0F);
    m_bheightinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);

    string.LoadString(IDS_BRICKDEPTH);
    m_bdepthinfo = HFloatPropertyInfo::New(string, "Brick Depth");
    m_bdepthinfo->SetDefaultValue(10.F);
    m_bdepthinfo->SetMinValue(0.F);
    m_bdepthinfo->SetMaxValue(10000.0F);
    m_bdepthinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);
    ...
    string.LoadString(IDS_MORTARSIZE);
    m_msizeinfo = HFloatPropertyInfo::New(string, "Mortar Size");
    m_msizeinfo->SetDefaultValue(1.F);
    m_msizeinfo->SetMinValue(0.F);
    m_msizeinfo->SetMaxValue(1.F);
    m_msizeinfo->SetFlags(HFloatPropertyInfo::FF_PERCENTAGE);
    m_msizeinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);

    string.LoadString(IDS_SOFTNESS);
    m_fuzzinfo = HFloatPropertyInfo::New(string, "Softness");
    m_fuzzinfo->SetDefaultValue(0.1F);
    m_fuzzinfo->SetMinValue(0.F);
    m_fuzzinfo->SetMaxValue(1.F);
    m_fuzzinfo->SetFlags(HFloatPropertyInfo::FF_PERCENTAGE);
    ...
    string.LoadString(IDS_BRICKCOLOR);
    ...
    string.LoadString(IDS_MORTARCOLOR);
    m_fcolorinfo = HColorPropertyInfo::New(string, "FColor");
    m_fcolorinfo->GetRed()->SetDefaultValue(1.F);
    m_fcolorinfo->GetGreen()->SetDefaultValue(1.F);
    m_fcolorinfo->GetBlue()->SetDefaultValue(1.F);
