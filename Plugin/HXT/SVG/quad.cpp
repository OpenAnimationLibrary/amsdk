...
constexpr float angle_weight_factor = 1.F;
constexpr float degree_weight_factor = 10.F;
...
void QuadrifyArea(Subdiv *s, const PolygonalArea *a) {
    ...
    SetAllFaceValsAndFvals(s, -1, 0.F);
