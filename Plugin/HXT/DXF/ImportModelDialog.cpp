// KB  9/25/02  \Ken95\Plugin\HXT\DXF\ImportModelDialog.cpp
...
CImportModelDialog::CImportModelDialog(): CPluginDialog(IDD, FromHandle(GetMainApplicationWnd())) {
    m_peaktolerance = GetRegistryValue("DXF Plugin", "Peak Tolerance", 45.0F);
...
void CImportModelDialog::OnOK() {
    CPluginDialog::OnOK();
    SetRegistryValue("DXF Plugin", "Peak Tolerance", m_peaktolerance);
}
