...
public:
    ...
    /*!	
        ...
        \sa HFRectangle, HFShape, HFObject
    */
    HFBitmap(int xmin, int ymin, int xmax, int ymax, int bitmapX, int bitmapY, const void *jpeg, int jpegSize);

    /*! */
    ~HFBitmap() override = default;
    ...
    /*!	
        ...
        \sa HFRectangle, HFShape, HFObject
    */
    HFBitmap(int xmin, int ymin, int xmax, int ymax, int format, int bitmap_X, int bitmap_Y, int numPaletteEntries, bool alpha, const void *bitmap, const void *palette);
