...
HFSound::HFSound(FILE *wavData, const int compression) {
    sound = new FDTDefineSoundWAV(wavData, compression);
    SetDefineTagId(sound->ID());
}

HFSound::HFSound(const int rate, const int size, const int type, const int sampleCount, const void *data, const int dataSize, const int compression) {
