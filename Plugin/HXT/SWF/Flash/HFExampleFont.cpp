...
void HLCreateFontMovie() {
    ...
    letterS->AddCurvedLine(-150,
                           40, // The delta from the previous point to the control point.
                           -50,
                           110); // The delta from the contol point to the end point.
    ...
    auto *text1 = new HFText("FLASH HSALF", font); // Creates the text box, with a bounding
    ...
    const FRGBA halfGreen = {0, 255, 0, 128};
