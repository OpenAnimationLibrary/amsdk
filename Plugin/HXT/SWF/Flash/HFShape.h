...
public:
    ...
    void SetLineWidth(const int _lineWidth) {
    ...
    [[nodiscard]] FRGBA GetLineColor() const {
        return lineColor;
    }
    ...
    [[nodiscard]] FRGBA GetSolidFillColor() const {
    ...
    int SetBitmapFillJpeg(int bitmap_X, int bitmap_Y, const void *JPEG, int JPEG_size);
    ...
    int SetBitmapFillLossless(int format, int bitmap_X, int bitmap_Y, int numPaletteEntries, bool alpha, const void *bitmap, const void *palette);
     ...
     */
    void Rotate(const SFIXED degree) {
        rotation = degree;
    }
     ...
     */
    void Scale(const SFIXED _scaleX, const SFIXED _scaleY) {
        scaleX = _scaleX;
        scaleY = _scaleY;
    }
