...
public:
    ...
    */
    HFActionGetURL(const char *_url);
    ...
    */
    HFActionGetURL(const char *_url, const char *_target);

    // Method for internal use.
    void AddToActionCondition(FActionCondition *ac) override;

    // Method for internal use.
    void AddToAction(FCTDoAction *doAction) override;
private:
    const char *url;
    const char *target;
};
...
/*!	
	\sa HFAction
*/
class HFActionStop final : public HFAction {
public:
    // Method for internal use.
    void AddToActionCondition(FActionCondition *ac) override;
