...
FCTDoAction::FCTDoAction() = default;
...
void FCTDoAction::WriteToSWFStream(FSWFStream *_SWFStream) {
    ...
    for (std::list<FActionRecord *>::iterator cursor = actionRecordList.begin(); cursor != actionRecordList.end(); ++cursor) {
...
FCTPlaceObject::FCTPlaceObject(const U16 _characterID, const U16 _depth, FMatrix *_matrix, FCXForm *_colorTransform) {
...
FCTPlaceObject2::FCTPlaceObject2(const U16 _hasClipDepth, const U16 _hasRatio, const U16 _hasChar, const U16 _hasMove, const U16 _depth, const U16 _characterID, FMatrix *_matrix, FCXForm *_colorTransform, const U16 _ratio, FString *_name, const U16 _clipDepth) {
...
void FCTPlaceObject2::WriteToSWFStream(FSWFStream *_SWFStream) {
    ...
    body.WriteBits(name != nullptr, 1);
    body.WriteBits(hasRatio, 1);
    body.WriteBits(colorTransform != nullptr, 1);
    body.WriteBits(matrix != nullptr, 1);
...
FCTProtect::FCTProtect() = default;

void FCTProtect::WriteToSWFStream(FSWFStream *_SWFStream) {
    _SWFStream->AppendTag(stagProtect, 0, nullptr);
}

/////////////////////////////////////////////////////////////////////////////////
//  --------  FCTRemoveObject ---------------------------------------------------

FCTRemoveObject::FCTRemoveObject(const U16 _characterID, const U16 _depth) {
    characterID = _characterID;
    depth = _depth;
}
...
FCTRemoveObject2::FCTRemoveObject2(const U16 _depth) {
    depth = _depth;
}
...
FCTShowFrame::FCTShowFrame() = default;
...
void FCTShowFrame::WriteToSWFStream(FSWFStream *_SWFStream) {
    ...
    _SWFStream->AppendTag(stagShowFrame, 0, nullptr);
}

/////////////////////////////////////////////////////////////////////////////
//  --------  FCTStartSound --------------------------------------------------

FCTStartSound::FCTStartSound(const U16 _soundID, FSoundInfo *_soundInfo) {
