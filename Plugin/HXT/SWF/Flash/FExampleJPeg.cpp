...
void CreateJPegMovie() {
    ...
    if (fp) {
        ...
        auto *bits = new FDTDefineBitsJPEG2(bitmap, // address of image data
        ...
        rectangleShapeRecords[0] = new FShapeRecChange(false, true, true, false, true, (ORIGIN_X + BITMAP_X) * SCoord1, (ORIGIN_Y + BITMAP_Y) * SCoord1, 0, 2, 0, nullptr, nullptr);
