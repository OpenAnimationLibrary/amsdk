...
public:
    ...
    void AlphaChannel(const bool on) {
        alphaT = on;
    }
    ...
    */
    ...
    void WriteToSWFStream(FSWFStream *_SWFStream) const;
...
public:
    ...
    FMatrix(U32 _hasScale, SFIXED _scaleX, SFIXED _scaleY, U32 _hasRotate, SFIXED _rotateSkew0, SFIXED _rotateSkew1, SCOORD _translateX, SCOORD _translateY);
...
private:
    ...
    [[nodiscard]] U32 MinBits(S32 x, S32 y) const;
    U16 identity;
};
...
public:
    ...
    [[nodiscard]] SCOORD Xmin() const {
        return xmin;
    }

    [[nodiscard]] SCOORD Ymin() const {
        return ymin;
    }

    [[nodiscard]] SCOORD Xmax() const {
        return xmax;
    }

    [[nodiscard]] SCOORD Ymax() const {
        return ymax;
    }

    [[nodiscard]] SCOORD Width() const {
        return xmax - xmin + 1;
    }

    [[nodiscard]] SCOORD Height() const {
        return ymax - ymin + 1;
    }

    void SetXmin(const SCOORD val) {
        xmin = val;
    }

    void SetYmin(const SCOORD val) {
        ymin = val;
    }

    void SetXmax(const SCOORD val) {
        xmax = val;
    }

    void SetYmax(const SCOORD val) {
        ymax = val;
    }
...
public:
    ...
    void WriteToSWFStream(FSWFStream *_SWFStream, bool writeNull) const;

    [[nodiscard]] U16 Length() const {
        return text.length();
    }
