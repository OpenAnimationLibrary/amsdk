...
constexpr int BITMAP_X = 32;
constexpr int BITMAP_Y = 32;
constexpr int SIZE_PALETTE = 256;
...
void AddShapesPage(HFMovie *movie) {
    ...
    SPOINT triangleData[3] = {{0, 1000}, {1000, 1000}, {500, 0}};

    auto *triangle = new HFPolygon(triangleData, 3);

    // Also the polygon class, but the object is built
    // piece by piece rather than being passed in as an array
    // by the constructor.
    auto *strange = new HFPolygon(200, 400);
    strange->AddCurvedLine(-150, -50, -50, -150);
    strange->AddCurvedLine(50, -150, 450, -50);
    strange->AddCurvedLine(450, 50, 50, 150);
    strange->AddCurvedLine(-50, 150, -150, 50);
    ...
    triangle->SetBitmapFillLossless(FDTDefineBitsLossless::bm8Bit, BITMAP_X, BITMAP_Y, SIZE_PALETTE, false, bitmapLossless, rgb);
...
void AddCirclePage(HFMovie *movie) {
    ...
    circle->SetDepth(42);
    circle->SetBitmapFillLossless(FDTDefineBitsLossless::bm8Bit, BITMAP_X, BITMAP_Y, SIZE_PALETTE, false, bitmapLossless, rgb);
...
void AddTextPage(HFMovie *movie) {
    ...
    auto *letterF = new HFPolygon(0, 200);
    ...
    auto *letterL = new HFPolygon(0, 200);
    ...
    auto *letterA = new HFPolygon(0, 800);
    ...
    auto *letterS = new HFPolygon(600, 200);
    letterS->AddStraightLine(-400, 0);
    letterS->AddCurvedLine(-150, 40, -50, 110); // top left curve of the S
    letterS->AddCurvedLine(50, 110, 150, 40);
    letterS->AddStraightLine(200, 0);
    letterS->AddStraightLine(0, 200);
    letterS->AddStraightLine(-400, 0);
    letterS->AddStraightLine(0, 100);
    letterS->AddStraightLine(400, 0);
    letterS->AddCurvedLine(70, -60, 30, -140); // lower right curve of the S
    letterS->AddCurvedLine(-30, -140, -70, -60);
    letterS->AddStraightLine(-200, 0);
    letterS->AddStraightLine(0, -100);
    letterS->AddStraightLine(400, 0);
    letterS->AddStraightLine(0, -100);
    ...
    auto *letterH = new HFPolygon(0, 200);
    ...
    auto *letterSpace = new HFPolygon(0, 0);

    // Now add the letters to the font.
    auto *font = new HFFont("Silly Font");
    ...
    auto *text = new HFText("FLASH", font); // Creates the text box, with a bounding
    ...
    constexpr FRGBA halfRed = {255, 0, 0, 128};
