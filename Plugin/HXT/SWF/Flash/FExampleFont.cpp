...
void CreateFontMovie() {
    ...
    auto *arial_b_o = new FDTDefineFont();

    //record this objects character ID for use later
    const U16 arial_b_oID = arial_b_o->ID();

    //create shape of letter "b"
    auto *letter_b = new FShape();
    ...
    letter_b->AddShapeRec(new FShapeRecChange(false, false, true, false, true, 157, -733, 0, 1, 0, nullptr, nullptr));
    ...
    letter_b->AddShapeRec(new FShapeRecChange(false, false, false, false, true, 150, -269, 0, 0, 0, nullptr, nullptr));
    ...
    auto *letter_o = new FShape();
    letter_o->AddShapeRec(new FShapeRecChange(false, true, true, false, true, 127, -265, 0, 1, 0, nullptr, nullptr));
    ...
    letter_o->AddShapeRec(new FShapeRecChange(false, false, false, false, true, 116, -484, 0, 0, 0, nullptr, nullptr));
    ...
    auto *arial_b_o_Info = new FDTDefineFontInfo("Arial", arial_b_oID, FDT::ShiftJIS, false, false);
    ...
    auto *b_o_b = new FDTDefineText2(new FRect(0, 0, 2000, 2000), //new FRect(94, 273, 3303, 1321),
                                     new FMatrix(),
    ...
    b_o_b->AddTextRecord(new FTextChangeRecord(true, true, false, false, arial_b_oID, 1440, new FColor(redA), 0, 1304));

    // create record that includes a list of which shapes to display and in what order
    auto *textGlyphRec = new FTextGlyphRecord();
