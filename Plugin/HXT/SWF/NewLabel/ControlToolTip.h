...
protected :
    ...
    CSize GetMultiLineTextExtent(CClientDC *pDC, LPCTSTR lpszText) const;
    int GetNumberOfLines(LPCTSTR lpszText = nullptr) const;
    [[nodiscard]] BOOL IsMouseInControl() const;
    void Show();

public :
    CControlToolTip();
    ~CControlToolTip() override;
    ...
    [[nodiscard]] BOOL ShowOnlyOnMouseClickDown() const {
    ...
    [[nodiscard]] BOOL IsLeftMouseButtonUsed() const {
