...
void gpc_define_4corner(gpc_polygon *p, int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4);

void gpc_define_3corner(gpc_polygon *p, int x1, int y1, int x2, int y2, int x3, int y3);

void gpc_write_polygon(FILE *outfile_ptr, int write_hole_flags, gpc_polygon *polygon);

void gpc_add_contour(gpc_polygon *polygon, const gpc_vertex_list *contour, int hole);
