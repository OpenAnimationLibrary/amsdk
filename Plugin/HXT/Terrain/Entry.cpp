// Dan  3/22/00  \Dan85\Plugin\Wizards\Grid\Entry.cpp
#include "StdAfx.h"
#include "StrClass.h"
#include "F_Protos.h"
#include "Wizard.h"
...
extern "C" __declspec(dllexport) BOOL HxtOnCommand(HTreeObject *htreeobject, const UINT index) {
    ...
    switch (index) {
        case MODEL:
            return ((CWizardApp *)AfxGetApp())->OnGridWizard((HModelCache *)htreeobject);
        case OBJECTCONTAINER:
            return ((CWizardApp *)AfxGetApp())->OnGridWizard(nullptr);
        default:
            return FALSE;
    }
}
