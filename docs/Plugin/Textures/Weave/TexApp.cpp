// Dan  3/24/2003  \DanLP105\Plugin\Textures\Weave\TexApp.cpp
//
...
BOOL CTextureApp::InitInstance() {
    ...
    m_amplitudeinfo->SetDefaultValue(75.0F);
    ...
    m_fuzzinfo->SetDefaultValue(0.F);
    ...
    m_mapinfoarray.SetArraySize(MAP_NUMBER);
    m_mapinfoarray[0]->SetMatchName("SPHERICAL");
    string.LoadString(IDS_SPHERICAL);
    m_mapinfoarray[0]->SetLocalizedName(string.GetBuffer());
    m_mapinfoarray[1]->SetMatchName("CYLINDRICALX");
    string.LoadString(IDS_CYLINDRICALX);
    m_mapinfoarray[1]->SetLocalizedName(string.GetBuffer());
    m_mapinfoarray[2]->SetMatchName("CYLINDRICALY");
    string.LoadString(IDS_CYLINDRICALY);
    m_mapinfoarray[2]->SetLocalizedName(string.GetBuffer());
    m_mapinfoarray[3]->SetMatchName("CYLINDRICALZ");
    string.LoadString(IDS_CYLINDRICALZ);
    m_mapinfoarray[3]->SetLocalizedName(string.GetBuffer());
    m_mapinfoarray[4]->SetMatchName("OLDSTYLE");
    string.LoadString(IDS_OLDSTYLE);
    m_mapinfoarray[4]->SetLocalizedName(string.GetBuffer());
    string.LoadString(IDS_MAP);
    m_mapinfo = HTypePropertyInfo::New(string, "Map", &m_mapinfoarray);
    m_mapinfo->SetDefaultIndex(OLDSTYLE);
    m_mapinfo->SetDrawWhen(HPropertyInfo::DRAWIFMATERIALS);
