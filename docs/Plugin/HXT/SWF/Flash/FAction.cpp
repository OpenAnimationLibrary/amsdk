...
FActionGetURL2::FActionGetURL2(const U8 _method) {
    method = _method;
}
...
FActionGotoFrame::FActionGotoFrame(const U16 _frameIndex) {
...
FActionGotoFrame2::FActionGotoFrame2(const U8 _play) {
...
FActionIf::FActionIf(const S16 _branchOffset) {
...
FActionJump::FActionJump(const S16 _branchOffset) {
...
FActionPush::FActionPush(const FLOAT _number) {
...
//////////////////////////////////////////////////////////////////////////////////////
//  --------  FActionWaitForFrame ----------------------------------------------------
FActionWaitForFrame::FActionWaitForFrame(U16 _frameIndex, U16 skipCount) {
...
FActionWaitForFrame2::FActionWaitForFrame2(const U8 _skipCount) {
...
void FActionCondition::AddKeyCode(const U32 keyCode) {
...
void FActionCondition::AddCondition(const U16 _condition) {
