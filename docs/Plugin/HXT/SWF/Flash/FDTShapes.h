...
public:
    ...
    /*!	Do we need the _has parameters?
      ...
      \param	 _hasAdd:  Has color addition values if equal to 1
      \param	 _hasMult:  Has color multipy values if equal to 1
      \param	 _redMultTerm: Red multiply value
      \param	 _greenMultTerm: Green multiply value
      \param	 _blueMultiTerm: Blue multiply value
      \param	 _redAddTerm: Red addition value
      \param	 _greenAddTerm: Green addition value
      \param	 _blueAddTerm: Blue addition value

     */
    FCXForm(U32 _hasAdd, U32 _hasMult, S32 _redMultTerm, S32 _greenMultTerm, S32 _blueMultiTerm, S32 _redAddTerm, S32 _greenAddTerm, S32 _blueAddTerm);
...
/*!	Do we need the _has parameters?
  ...
  \param	_greenMultTerm: Green multiply value
  \param	_blueMultiTerm: Blue multiply value
  \param	_alphaMultTerm: Alpha transparency multiply value
  \param	_redAddTerm: Red addition value
  \param	 _greenAddTerm: Green addition value
  \param	_blueAddTerm: Blue addition value
  \param	_alphaAddTerm: Alpha transparency addition value

 */
class FCXFormWAlpha : public FACXForm {

public:
    FCXFormWAlpha(U32 _hasAdd, U32 _hasMult, S32 _redMultTerm, S32 _greenMultTerm, S32 _blueMultTerm, S32 _alphaMultTerm, S32 _redAddTerm, S32 _greenAddTerm, S32 _blueAddTerm, S32 _alphaAddTerm);
...
public:
    ...
    */
    ...
    to create a morph fill style 
        \param	fillStyle
    */
    U32 AddFillStyle(FMorphFillStyle *fillStyle) const;
    ...
    /*!	 You need a pair of line styles (lineWidth + lineColor),
        ...
        */
    U32 AddLineStyle(U32 startLineWidth, FColor *startLineColor, U32 finalLineWidth, FColor *finalLineColor) const;
...
public:
    ...
    */
    ...
    \param	_shapeRec
    */
    void AddShapeRec(FShapeRec *_shapeRec) const;
    ...
    */
    U32 AddFillStyle(FFillStyle *fillStyle) const;
    ...
    /*!	Remember to store the position of the fill style. Use this when 
        ...
        \return the position in the array.  when creating the shape change record later.
    */
    U32 AddSolidFillStyle(FColor *fillColor) const;
    ...
    /*!	Remember to store the position of the fill style. Use this 
        ...
        \return the position in the array. 
    */
    U32 AddLineStyle(U32 lineWidth, FColor *lineColor) const;
...
public:
    FFillStyleArray() = default;
    virtual ~FFillStyleArray();
...
public:
    ...
    /*!	
      ...
      \param _ratio know one knows for sure
      \param _color one of the colors to shift through
     */
    FGradRecord(U32 _ratio, FColor *_color);

    ~FGradRecord() override;
...
class FMorphFillStyle : public FAFillStyle {
public:
    ~FMorphFillStyle() override = default;
    void WriteToSWFStream(FSWFStream *_SWFStream) override {}
};
...
clipped (tiledFlag==0)	
    ...
    ~FMorphFillStyleBitmap() override;
    void WriteToSWFStream(FSWFStream *_SWFStream) override;
...
public:
    ...
    */
    ...
    ~FMorphFillStyleGradient() override;
...
public:
    FShapeRecChange(U32 _stateNewStyles, U32 _stateLineStyle, U32 _stateFillStyle1, U32 _stateFillStyle0, U32 _stateMoveTo, S32 _moveDeltaX, S32 _moveDeltaY, U32 _fill0Style, U32 _fill1Style, U32 _lineStyle, FFillStyleArray *_fillStyles, FLineStyleArray *_lineStyles);

    ~FShapeRecChange() override;

    void WriteToSWFStream(FSWFStream *_SWFStream) override;
    void IncludeNFillBitInfo(U32 _nFillBits) override;
    void IncludeNLineBitInfo(U32 _nLineBits) override;
...
public:
    ...
    */
    ...
    ~FShapeRecEdgeStraight() override = default;
...
public:
    ...
    */
    ...
    ~FShapeRecEdgeCurved() override = default;
...
public:
    ...
    void AddShapeRec(FShapeRec *shapeRec);
    void WriteToSWFStream(FSWFStream *_SWFStream);
    [[nodiscard]] U32 NumFillBits() const;
    [[nodiscard]] U32 NumLineBits() const;
