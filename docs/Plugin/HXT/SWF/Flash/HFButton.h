...
public:
    ...
    */
    ...
    HFButton(HFShape *shape1, HFShape *shape2, HFShape *shape3, HFShape *shape4);
    ...
    void QueueEvent(HFAction *action, int event) const;

    // Method for internal use.
    void AddToObjectList(std::list<FObj *> *objList, HFMovie *movie) override;
