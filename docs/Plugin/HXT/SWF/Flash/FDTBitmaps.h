...
public:
    FDTDefineBitsJPEG3(U8 *_JPEGStream, U32 _JPEGSize, U8 *_alphaStream, U32 _alphaSize);
    U16 ID() override;
    void WriteToSWFStream(FSWFStream *_SWFStream) override;
...
public:
    ...
    FDTDefineBitsLosslessBase(U8 _format, U16 _width, U16 _height, int _colorTableCount, const void *_colorTableData, const void *_imageData, bool _alpha);
    ~FDTDefineBitsLosslessBase() override;
    void WriteToSWFStream(FSWFStream *_SWFStream) override;
