...
public:
    virtual ~FAButtonRecord() = default;
...
public:
    ...
    ~FDTDefineButtonCXForm() override;
    void WriteToSWFStream(FSWFStream *_SWFStream) override;
...
public:
    FDTDefineButtonSound(U16 _buttonID, U16 _soundID0, FSoundInfo *_soundInfo0, U16 _soundID1, FSoundInfo *_soundInfo1, U16 _soundID2, FSoundInfo *_soundInfo2, U16 _soundID3, FSoundInfo *_soundInfo3);
    ~FDTDefineButtonSound() override;
    void WriteToSWFStream(FSWFStream *_SWFStream) override;
