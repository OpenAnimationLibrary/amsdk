...
MirrorBonesDialog::MirrorBonesDialog(CWnd *pParent /*=nullptr*/) : CDialog(IDD, pParent)
...
void MirrorBonesDialog::DoDataExchange(CDataExchange *pDX) {
    ...
    DDX_Radio(pDX, IDC_RADIO_LEFT, m_adjustright);
    ...
    DDV_MinMaxFloat(pDX, m_tolerance, 0.001F, 10.F);
