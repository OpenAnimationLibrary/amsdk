ashObject \*parent, HHashObject \*oldersibling, BOOL select=TRUE, BOOL markparentmodified=TRUE) | <a href="classHHashObject.md" class="el">HHashObject</a> |  |
| <a href="classHTranslateLimits.md#3d9cbd41ce5e98d53ee169d9547259d7" class="el">New</a>() | <a href="classHTranslateLimits.md" class="el">HTranslateLimits</a> | ` [static]` |
