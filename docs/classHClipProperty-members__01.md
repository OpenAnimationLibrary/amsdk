classHHashObject.md#a3ac19480844c50f1325365d248712da" class="el">Move</a>(HHashObject \*parent, HHashObject \*oldersibling, BOOL select=TRUE, BOOL markparentmodified=TRUE) | <a href="classHHashObject.md" class="el">HHashObject</a> |  |
...
| <a href="classHClipProperty.md#3d9cbd41ce5e98d53ee169d9547259d7" class="el">New</a>() | <a href="classHClipProperty.md" class="el">HClipProperty</a> | ` [static]` |
| <a href="classHClipProperty.md#1729ddaa8ad04ecce9458dbcadca27a4" class="el">New</a>(HClipPropertyInfo \*propinfo) | <a href="classHClipProperty.md" class="el">HClipProperty</a> | ` [static]` |
| <a href="classHContainerProperty.md#5d97edce62d064870e238bb938a6450e" class="el">HContainerProperty::New</a>(HPropertyInfo \*propinfo) | <a href="classHContainerProperty.md" class="el">HContainerProperty</a> | ` [static]` |
...
| <a href="classHClipProperty.md#ca1082dbcc5c8b901a20217ec807126a" class="el">ReadBitmap</a>(float x, float y, RGBFloat \*diffuse, float \*opacity, float pixelwidth) | <a href="classHClipProperty.md" class="el">HClipProperty</a> |  |
| <a href="classHClipProperty.md#77ac82e852b4b80d35a721f165a09810" class="el">ReadBitmap</a>(float x, float y, ColorVector \*diffuse, float \*opacity, float pixelwidth) | <a href="classHClipProperty.md" class="el">HClipProperty</a> |  |
| <a href="classHClipProperty.md#ad204355a7fa5e0532f764267dc09c67" class="el">ReadBumpmap</a>(float x, float y, Vector2 &delta, float pixelwidth) | <a href="classHClipProperty.md" class="el">HClipProperty</a> |  |
