...
# HRotatePropertyInfo Class Reference

`#include <`<a href="HPropert_8h-source.md" class="el"><code>HPropert.h</code></a>`>`

Inheritance diagram for HRotatePropertyInfo:

<span class="image placeholder" original-image-src="classHRotatePropertyInfo__inherit__graph.gif" original-image-title="" border="0" usemap="#HRotatePropertyInfo__inherit__map">Inheritance graph</span>

\[[legend](graph_legend.md)\]

Collaboration diagram for HRotatePropertyInfo:

<span class="image placeholder" original-image-src="classHRotatePropertyInfo__coll__graph.gif" original-image-title="" border="0" usemap="#HRotatePropertyInfo__coll__map">Collaboration graph</span>

\[[legend](graph_legend.md)\]

[List of all members.](classHRotatePropertyInfo-members.md)
...
<tr>
<td class="memItemLeft" style="text-align: right;" data-nowrap="" data-valign="top">static <a href="classHRotatePropertyInfo.md" class="el">HRotatePropertyInfo</a> * </td>
<td class="memItemRight" data-valign="bottom"><a href="classHRotatePropertyInfo.md#3184c8fe6d6f9a3b2284ddcadfd1424f" class="el">New</a> (const char *localizedname, const char *matchname)</td>
</tr>
</tbody>
</table>
...
Definition at line <a href="HPropert_8h-source.md#l00396" class="el">396</a> of file <a href="HPropert_8h-source.md" class="el">HPropert.h</a>.
...
<tbody>
<tr>
<td class="md" data-nowrap="" data-valign="top">static <a href="classHRotatePropertyInfo.md" class="el">HRotatePropertyInfo</a>* HRotatePropertyInfo::New</td>
