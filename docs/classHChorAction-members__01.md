ss="el">New</a>(const char \*name=NULL, BOOL embedded=TRUE, BOOL insertintoactioncachecontainer=TRUE) | <a href="classHActionCache.md" class="el">HActionCache</a> | ` [static]` |
