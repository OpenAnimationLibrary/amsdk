...
# HPointerPropertyInfo Class Reference

`#include <`<a href="HPropert_8h-source.md" class="el"><code>HPropert.h</code></a>`>`

Inheritance diagram for HPointerPropertyInfo:

<span class="image placeholder" original-image-src="classHPointerPropertyInfo__inherit__graph.gif" original-image-title="" border="0" usemap="#HPointerPropertyInfo__inherit__map">Inheritance graph</span>

\[[legend](graph_legend.md)\]

Collaboration diagram for HPointerPropertyInfo:

<span class="image placeholder" original-image-src="classHPointerPropertyInfo__coll__graph.gif" original-image-title="" border="0" usemap="#HPointerPropertyInfo__coll__map">Collaboration graph</span>

\[[legend](graph_legend.md)\]

[List of all members.](classHPointerPropertyInfo-members.md)
...
<tr>
<td class="memItemLeft" style="text-align: right;" data-nowrap="" data-valign="top">static <a href="classHPointerPropertyInfo.md" class="el">HPointerPropertyInfo</a> * </td>
<td class="memItemRight" data-valign="bottom"><a href="classHPointerPropertyInfo.md#3184c8fe6d6f9a3b2284ddcadfd1424f" class="el">New</a> (const char *localizedname, const char *matchname)</td>
</tr>
</tbody>
</table>
...
Definition at line <a href="HPropert_8h-source.md#l00949" class="el">949</a> of file <a href="HPropert_8h-source.md" class="el">HPropert.h</a>.
...
<tbody>
<tr>
<td class="md" data-nowrap="" data-valign="top">static <a href="classHPointerPropertyInfo.md" class="el">HPointerPropertyInfo</a>* HPointerPropertyInfo::New</td>
...
<p>Reimplemented in <a href="classHClipPropertyInfo.md#3184c8fe6d6f9a3b2284ddcadfd1424f" class="el">HClipPropertyInfo</a>.</p></td>
</tr>
</tbody>
</table>
